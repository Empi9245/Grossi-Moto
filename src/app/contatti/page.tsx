        ...
        <div className="mx-auto grid max-w-[92rem] gap-10 xl:grid-cols-[minmax(0,1.15fr)_minmax(24rem,0.85fr)] xl:items-end xl:gap-12 2xl:gap-16">
          ...
          <div className="max-w-[38rem] xl:pb-2">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
              ...
              <Link
                href="#richiesta"
                className="font-ui inline-flex min-h-12 items-center justify-center gap-2 rounded-[0.9rem] border border-[#0A0A0A]/18 px-6 py-3 text-sm font-bold uppercase tracking-[0.08em] text-[#0A0A0A] transition-[border-color,background-color,transform] duration-150 hover:border-[#0A0A0A]/35 hover:bg-black/[0.035] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A34A3E]/45 focus-visible:ring-offset-4 focus-visible:ring-offset-white motion-reduce:transform-none motion-reduce:transition-none"
              >
                Invia una richiesta
              </Link>
              <Link
                href="#sede"
                className="font-ui group inline-flex min-h-11 items-center justify-center gap-2 rounded-[0.9rem] border border-[#A34A3E]/30 px-4 text-sm font-bold text-[#A34A3E] outline-none transition-opacity duration-150 hover:opacity-70 focus-visible:ring-2 focus-visible:ring-[#A34A3E]/40 focus-visible:ring-offset-4 focus-visible:ring-offset-white motion-reduce:transition-none sm:justify-start"
              >
                Come raggiungerci
                <ActionMark />
              </Link>
            ...
            {channels.map(({ icon: Icon, label, value, href, cta, note }) => (
              ...
              >
                <div className="flex items-center gap-3 text-[#A34A3E]">
                  <Icon aria-hidden="true" className="h-10 w-10 rounded-full bg-[#A34A3E]/10 p-2.5 text-[#A34A3E]" strokeWidth={1.8} />
          ...
          <div className="mx-auto grid max-w-[92rem] gap-12 xl:grid-cols-[minmax(0,1fr)_minmax(24rem,0.72fr)] xl:items-start xl:gap-20">
            <div>
              ...
              <a
                ...
                className="font-ui group mt-8 inline-flex min-h-12 items-center justify-center gap-2 rounded-[0.9rem] bg-white px-6 py-3 text-sm font-bold uppercase tracking-[0.08em] text-[#0A0A0A] transition-[background-color,transform] duration-150 hover:bg-white/90 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-4 focus-visible:ring-offset-[#111111] motion-reduce:transform-none motion-reduce:transition-none"
              >
                Apri su Google Maps
                <ActionMark />
              </a>
      ...
      <section className="px-5 py-20 sm:px-7 sm:py-24 md:px-10 lg:px-14 lg:py-28 xl:px-20">
        <div className="mx-auto flex max-w-[92rem] flex-col gap-8 pt-10 xl:flex-row xl:items-end xl:justify-between xl:gap-14 xl:pt-14">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <Link
              href="#richiesta"
              className="font-ui inline-flex min-h-12 items-center justify-center rounded-[0.9rem] border border-[#A34A3E] px-6 py-3 text-sm font-bold uppercase tracking-[0.08em] text-[#A34A3E] transition-[background-color,color,transform] duration-150 hover:bg-[#A34A3E] hover:text-white active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A34A3E]/45 focus-visible:ring-offset-4 focus-visible:ring-offset-white motion-reduce:transform-none motion-reduce:transition-none"
            >
              Invia una richiesta
            </Link>
          </div>
