...
export function WorkshopSection() {
  return (
    <section className="relative overflow-hidden bg-[var(--home-workshop-surface)] px-4 py-20 text-[var(--gm-ink)] sm:px-6 sm:py-24 lg:px-10 lg:py-32">
      <div
        aria-hidden="true"
        ...
        <div className="border-y border-black/16">
          ...
          <article className="grid gap-5 py-7 sm:grid-cols-[2.6rem_minmax(0,1fr)]">
            ...
            <div>
              ...
              <ul className="mt-6 grid gap-x-5 gap-y-3 text-xs font-bold uppercase tracking-[0.12em] text-black/82 sm:grid-cols-2">
