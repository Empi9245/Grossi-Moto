...
export function AccessoriesSection() {
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-[32px] bg-[oklch(96.5%_0.01_285)] px-5 py-20 sm:rounded-[40px] sm:px-7 sm:py-28 md:px-10 lg:rounded-[56px] lg:px-14 lg:py-32 xl:px-20">
