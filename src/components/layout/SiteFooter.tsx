...
export function SiteFooter() {
  return (
    <footer className="bg-[var(--gm-black)] px-4 py-10 text-white sm:px-6 lg:px-10">
      <div className="mx-auto grid max-w-[92rem] gap-8 border-t border-white/14 pt-8 md:grid-cols-[minmax(0,1fr)_auto] md:items-start">
        <div>
