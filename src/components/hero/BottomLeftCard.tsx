...
export function BottomLeftCard() {
  ...
  return (
    <motion.a
      ...
      className="group relative z-20 ml-3 mb-[calc(5.25rem+env(safe-area-inset-bottom))] w-[min(11.5rem,calc(100%-1.5rem))] shrink-0 rounded-[1.15rem] bg-[var(--panel)] p-3 text-[oklch(17%_0.012_40)] shadow-[0_24px_80px_rgba(17,11,9,0.34)] transition-colors hover:bg-[oklch(96%_0.01_80)] active:bg-[oklch(88%_0.014_78)] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--panel)] sm:ml-5 sm:mb-[calc(6rem+env(safe-area-inset-bottom))] sm:w-[13rem] sm:rounded-[1.35rem] sm:p-4 md:ml-7 md:w-[14rem] md:rounded-[1.55rem] md:p-5 lg:ml-8 lg:mb-8 xl:ml-10 xl:mb-10 [@media(min-width:80rem)_and_(min-height:54rem)]:w-[19.5rem] [@media(min-width:80rem)_and_(min-height:54rem)]:rounded-[1.65rem]"
    >
      ...
      <span className="font-ui mt-4 hidden items-center justify-between gap-3 border-t border-[oklch(24%_0.016_45/0.14)] pt-3 text-sm font-semibold [@media(min-width:80rem)_and_(min-height:54rem)]:flex">
