...
export function Navbar() {
  ...
  return (
    <nav className="relative z-20 flex w-full items-center justify-between px-4 py-4 sm:px-6 sm:py-5 lg:px-8 lg:py-6 xl:px-10 xl:py-7">
      <motion.a
        href="/"
        aria-label="Grossimoto homepage"
