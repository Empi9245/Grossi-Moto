...
export function BottomRightCorner() {
  ...
  return (
    <motion.div
      ...
      className="absolute bottom-0 right-0 z-20 bg-[var(--page-background)] pl-2.5 pt-2.5 sm:pl-4 sm:pt-4"
    >
      <CornerMask
