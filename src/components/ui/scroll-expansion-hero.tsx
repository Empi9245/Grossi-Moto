...
export default function ScrollExpansionHero({
  ...
  return (
    ...
    >
      <section className="relative flex min-h-[100lvh] flex-col items-center justify-start">
        <div className="relative flex min-h-[100lvh] w-full flex-col items-center">
          ...
          >
            <Image
              ...
              width={1920}
              height={1080}
              className="h-[100lvh] w-screen object-cover object-center"
              priority
            />
          ...
          <div className="relative z-10 flex w-full flex-col items-center justify-start">
            <div className="relative flex h-[100lvh] w-full flex-col items-center justify-center">
              <div
                ...
                style={{
                  ...
                  height: reducedMotion ? "100lvh" : mediaHeight,
                  maxWidth: "100vw",
                  maxHeight: "100lvh",
